...
export const schedule = {
  ...
  day2: [
    { id: 'd2-1', time: '09:00 - 09:45', title: 'Data Storytelling: From Numbers to Narratives', speakerId: '5', location: 'Main Stage', description: 'Learn how to effectively communicate insights from data through compelling visualizations and narratives. This session will cover tools and techniques for impactful data storytelling.', audience: 'Data Analysts, Product Managers', objectives: ['Learn data visualization principles', 'Craft compelling narratives with data'] },
    { id: 'd2-2', time: '10:00 - 10:45', title: 'Penetration Testing 101', speakerId: '6', location: 'Room A', description: 'Step into the shoes of a hacker to find and fix vulnerabilities in your systems. This introductory session covers the basics of ethical hacking and penetration testing.', audience: 'Developers, Security Enthusiasts', objectives: ['Understand the penetration testing lifecycle', 'Learn to use basic security tools'] },
    { id: 'd2-3', time: '10:00 - 10:45', title: 'Modern CSS: Beyond Flexbox and Grid', speakerId: '3', location: 'Room B', description: 'Explore the latest advancements in CSS, including container queries, cascade layers, and new color spaces. Level up your styling game with these powerful features.', audience: 'Frontend Developers', objectives: ['Learn about new CSS features', 'Apply modern CSS techniques in projects'] },
    { id: 'd2-4', time: '11:00 - 11:45', title: 'Machine Learning Operations (MLOps)', speakerId: '2', location: 'Room C', description: 'Discover the principles and practices of MLOps for streamlining the machine learning lifecycle. Learn how to build, deploy, and monitor ML models at scale.', audience: 'AI/ML Engineers, DevOps', objectives: ['Understand the MLOps workflow', 'Learn about tools for automating ML pipelines'] },
    { id: 'd2-5', time: '11:00 - 11:45', title: 'Closing Ceremony & Awards', speakerId: '1', location: 'Main Stage', description: 'Join us as we wrap up an amazing conference. We will announce hackathon winners, give away prizes, and share closing thoughts.', audience: 'All', objectives: ['Celebrate achievements', 'Network with fellow attendees'] },
  ],
};
