      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg mb-6">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black bg-gradient-to-r from-[#4285F4] via-[#EA4335] to-[#FBBC05] bg-clip-text text-transparent">
              IT Jobfair Exhibition
            </h2>
          </div>

          <div className="max-w-3xl mx-auto">
            <h3 className="text-2xl md:text-3xl font-bold text-[#34A853] mb-4">
              To all tech enthusiasts
            </h3>
            <p className="text-lg md:text-xl text-[#222] font-medium mb-2">
              Coders, engineers, or product minds
            </p>
            <p className="text-base md:text-lg text-[#666] font-semibold">
        ...
        <div className="max-w-6xl mx-auto mb-12">
          ...
          <div className="flex justify-start mb-0 -mb-6 ml-8 relative z-10">
            <div className="inline-block bg-gradient-to-r from-[#EA4335] to-[#C71610] text-white px-6 py-3 rounded-2xl shadow-xl transform -rotate-3">
          ...
          <Card className="bg-white border-4 border-[#4285F4] rounded-3xl shadow-2xl overflow-hidden">
            <CardContent className="p-8 md:p-12">
              <h3 className="text-2xl md:text-3xl font-black text-center mb-8 text-[#222]">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {benefits.map((benefit, index) => (
                  <div
                    key={index}
                    className={`flex gap-4 p-6 rounded-2xl ${benefit.bg} border-2 border-transparent hover:border-current transition-all hover:scale-105 cursor-pointer`}
                  >
                    <div className={`${benefit.color} flex-shrink-0`}>
                      {benefit.icon}
                    </div>
                    <div>
                      <h4 className={`font-bold text-lg mb-2 ${benefit.color}`}>
                        {benefit.title}
                      </h4>
        ...
        <div className="text-center">
          <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 max-w-4xl mx-auto border-4 border-[#FBBC05]">
            <h3 className="text-2xl md:text-4xl font-black text-[#222] mb-6">
              Ready to Launch Your Tech Career? 🎯
            </h3>
            <p className="text-lg md:text-xl text-[#666] mb-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              >
                <Button
                  size="lg"
                  className="text-lg md:text-xl px-10 py-6 rounded-full bg-gradient-to-r from-[#4285F4] to-[#1a73e8] hover:from-[#1a73e8] hover:to-[#4285F4] text-white shadow-xl hover:shadow-2xl transition-all hover:scale-105 font-black"
                >
